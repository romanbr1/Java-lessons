...
public class Application {
	...
	public static void checkInput(String x) throws WrongInputConsoleParametersException{
		
		int z=(int)x.charAt(0);
		if((x.length()>1)||(z<48)||(z>57)) {
			String message = "wrong input, read menu";
